...
apiController.geolocation = (req, res, next) => {
  ...
  axios
    .get(`http://api.ipapi.com/api/check?access_key=${GEO_API}`)
    .then(response => {
...
apiController.yelp = (req, res, next) => {
  ...
  const YELP_API =
    "0asdq3RZT2Kcg24r5KLnY49GRgND03gI53KjmnXTaFEsPoe8YaSyyhVNciXqh2GGLrV1i7X79sBWjkWw_NhhMeG9GSOOylFrRXxnFSZuLxQvDj-5bOzL1JsZ-UbGXXYx";
  ...
  let params = [
    { term: req.body.searchInput },
    { location: req.body.location || res.locals.zipcode, limit: 50 }
  ];
